...
import { HomeIcon, LifeBuoy, Bell, UsersIcon } from 'lucide-react'
    ...
    return (
        <aside className='w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0'>
            <div className='p-5 border-b border-base-300'>
                <Link to="/" className='gap-2.5 flex items-center'>
            ...
            <nav className='flex-1 p-4 space-y-1 '>
                <Link to="/" className={`btn justify-start btn-ghost w-full gap-3 px-3 normal-case ${currentPath === '/' ? 'btn-active' : ''}`}>
            ...
            <div className='flex mt-auto p-4  border-base-300'>
